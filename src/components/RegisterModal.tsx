...
function shouldShowModal(): boolean {
  ...
  if (localStorage.getItem("registered") === "true") return false;
  if (sessionStorage.getItem("registerModalDismissed") === "true") return false;
  return true;
}
    ...
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
        ...
        <FormField control={form.control} name="age" render={({ field }) => (
          <FormItem><FormLabel>Age</FormLabel><FormControl><Input type="number" placeholder="Age" {...field} /></FormControl><FormMessage /></FormItem>
        )} />
        ...
        <FormField control={form.control} name="depressionLevel" render={({ field }) => (
          <FormItem>
      ...
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
        <FormField control={form.control} name="emailOrPhone" render={({ field }) => (
          <FormItem>
            ...
            <FormControl><Input placeholder="you@example.com or 123‑456‑7890" {...field} /></FormControl>
            <FormMessage />
          </FormItem>
        )} />
        <FormField control={form.control} name="password" render={({ field }) => (
...
export default function RegisterModal() {
  ...
  const handleOpenChange = (isOpen: boolean) => {
    setOpen(isOpen);
    if (!isOpen) {
      sessionStorage.setItem("registerModalDismissed", "true");
    }
  };
